...
from basicsr.stage_one_9parameter import first_GNN
...
def get_args_parser():
    ...
    parser.add_argument('--train_dir', default=r'train', help='Sample storage location')
    parser.add_argument('--test_dir', default=r'test', help='Sample storage location')
    parser.add_argument('--save_dir', default=r'stage_one_9parameter', help='Save training parameters')
    return parser
...
def test(model, test_dates, opt):
    ...
    try:
        f2 = open(r'train_stage_one_9para.txt', 'a+')
        # new_line2 = ''.join(i)
